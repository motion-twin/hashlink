...
typedef DWORD(WINAPI *DirectInput8Create_t)(HINSTANCE hinst, DWORD dwVersion, REFIID riidltf, LPVOID * ppvOut, LPUNKNOWN punkOuter);
...
const DIDATAFORMAT _c_dfDIJoystick2 = {
	sizeof(DIDATAFORMAT),
